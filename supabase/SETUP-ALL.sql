...
-- ============================================================
-- tmk_sales — เก็บการขายจริง (atomic กับการตัดสต็อก) + รายงานอ่านจากตารางนี้
-- ============================================================
...
-- ============================================================
-- FUNCTION — tmk_fulfill_order: ตัดสต็อก + บันทึกการขาย + สถานะออเดอร์ atomic (1 transaction)
-- ============================================================
