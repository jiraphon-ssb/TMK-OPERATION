...
const T = {
  th: {
    ...
    subCampaigns: 'แคมเปญ', subReport: 'รายงานขาย', subPerf: 'ประสิทธิภาพเซลล์', subOrders: 'ออเดอร์', subEntry: 'บันทึกขาย', subShirts: 'สินค้า', subCrm: 'ลูกค้า (CRM)', subHealth: 'สุขภาพข้อมูล', subImport: 'ข้อมูล', subCustomers2: 'ลูกค้า', subShopCust: 'ลูกค้าร้าน', subAudit: 'ประวัติการใช้งาน', subRoles: 'สิทธิ์ผู้ใช้', subTrash: 'ถังขยะ',
  ...
  en: {
    ...
    subCampaigns: 'Campaigns', subReport: 'Sales report', subPerf: 'Performance', subOrders: 'Orders', subEntry: 'Sale entry', subShirts: 'Products', subCrm: 'Customers', subHealth: 'Data health', subImport: 'Data', subCustomers2: 'Customers', subShopCust: 'Shop customers', subAudit: 'Activity Log', subRoles: 'User Roles', subTrash: 'Trash',
