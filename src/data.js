...
export const TMK = {
  ...
  poTracker: [],
  fb: { revenue: 0, spend: 0, inquiries: 0, orders: 0, newCust: 0, oldCust: 0, roas: 0, acos: 0, conv: 0, aov: 0, cpInq: 0, cpOrd: 0, cac: 0 },
  fbMsgTrend: [],
  dailyLog: [],
  audit: [],
  roles: [],
  ...
  duties: [],
  computed: { MTD: 0, ORD: 0, AD: 0, NEW_REV: 0, OLD_REV: 0, NEW_C: 0, OLD_C: 0, PACE_TGT: 0, PACE_PCT: 0, RUN: 0, AOV: 0, ACOS_TOT: 0, CAC: 0 },
};
