    ...
    topics: [
      ...
      { id: 'sales-ads', title: 'โฆษณาและแชท', level: 'new',
        ...
        guide: [
          ...
          { nav: ['sales', 'ads'], target: '.content-inner .card:nth-child(3)', title: 'แคมเปญแอด', desc: 'ตารางแคมเปญโฆษณาของเดือนที่เลือก: ชื่อ / แพลตฟอร์ม / งบ / ใช้ไป / ROAS / สถานะ — สร้าง/แก้แคมเปญได้ที่หน้า "ภาพรวมรายเดือน"' },
      ...
      { id: 'sales-cust', title: 'ลูกค้า', level: 'used',
        ...
        guide: [
          { nav: ['sales', 'customers'], target: '.content-inner .grid.g4', title: 'กลุ่มลูกค้า', desc: 'การ์ดกลุ่มลูกค้าจากข้อมูลจริงใน Supabase (จำนวน + % รายได้) — แก้ได้ที่ "ภาพรวมรายเดือน → กลุ่มลูกค้า"' },
      ...
      { id: 'record-sales', title: 'บันทึกยอดขายรายวัน', level: 'new',
        ...
        guide: [
          { nav: ['sales', 'monthly'], target: '.content-inner', title: 'ปุ่มกรอกยอดวันนี้', desc: 'การ์ดซ้ายบนมีปุ่มใหญ่ "กรอกยอดวันนี้" + ความคืบหน้า + กราฟแนวโน้ม — กรอกแยกแต่ละช่องทางครบ (รายได้/ออร์เดอร์/ค่าแอด/แชท/ลูกค้า) บันทึกลง Supabase ไม่หาย' },
          { nav: ['sales', 'monthly'], target: '.content-inner', title: 'ปฏิทินยอดขาย', desc: 'การ์ดขวาบนเป็นปฏิทิน แสดงยอดขายแต่ละวัน — เขียว = กรอกแล้ว, ขอบฟ้า = วันนี้ — กดวันไหนก็ได้เพื่อกรอก/แก้ไขย้อนหลัง' },
        ]},
      { id: 'per-month', title: 'ข้อมูลแยกตามเดือน', level: 'used',
        content: 'เปลี่ยนเดือน ตัวเลขเปลี่ยนตาม',
        guide: [
          { nav: ['sales', 'overview'], target: '.content-inner .card:first-child', title: 'ทุกหน้าแยกตามเดือน', desc: 'ทุกหน้าที่มีแถบเลือกเดือน (ยอดขาย/บันทึก & ภาพรวมเดือน) จะแสดงข้อมูลของ "เดือนที่เลือก" จริง — เลื่อนไปอดีต/อนาคต ตัวเลขเปลี่ยนตามทันที' },
        ]},
      { id: 'monthly-setup', title: 'ภาพรวมรายเดือน', level: 'used',
        content: 'ภาพรวมเดือนเดียวจบ: ยอด เป้า กรอก แคมเปญ',
        guide: [
          { nav: ['sales', 'monthly'], target: '.content-inner .card:first-child', title: 'สรุปเดือน + ปุ่มหลัก', desc: 'การ์ดบนสุดสรุปยอด/เป้า/pace + ปุ่มใหญ่ทำสิ่งสำคัญของเดือนนั้น (กรอกยอดวันนี้ / กรอกย้อนหลัง / ตั้งเป้าล่วงหน้า)' },
          { nav: ['sales', 'monthly'], target: '.content-inner', title: 'การ์ดเรียงลงมา', desc: 'การกรอกยอดรายวัน (ปฏิทินคลิกได้) · เป้าหมาย & งบ · แคมเปญแอด · กลุ่มลูกค้า & ข้อมูลย้อนหลัง — ครบในหน้าเดียว' },
        ]},
      { id: 'month-nav', title: 'การนำทางเดือน + ไตรมาส', level: 'used',
        content: 'เลื่อนดูเดือนอื่นและ Quarter View',
        guide: [
          { nav: ['sales', 'monthly'], target: '.content-inner .card:first-child', title: 'Month Navigator', desc: 'ลูกศรซ้าย/ขวาเปลี่ยนเดือน กดชื่อเดือนเพื่อ Quick Jump เลือกเดือนจาก grid 12 เดือน กดปุ่ม "ดูรายไตรมาส" ดูภาพรวม Q1-Q4' },
        ]},
    ]
  },
  {
