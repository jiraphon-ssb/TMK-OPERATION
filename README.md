...
> 🛠 **นักพัฒนา/AI agent:** อ่าน [`CLAUDE.md`](CLAUDE.md) ก่อนเริ่ม — สรุปสถาปัตยกรรม, กติกา (commit/migration/edge fn), คำศัพท์, และ verify workflow

---

## ✨ ฟีเจอร์หลัก (ตาม NAV_DEF ปัจจุบัน)

| โมดูล | รายละเอียด |
|---|---|
| **หน้าหลัก** (home) | ภาพรวมเรียลไทม์เดือนปัจจุบัน: ยอด MTD, pace, KPI |
| **ยอดขาย** (sales) | ภาพรวม / ช่องทาง / แอด / ลูกค้า / ยอดเดือน — มาร์เก็ตเพลส + สรุปเดือน (เทียบ MoM/YoY) |
| **โครงการ** (flows) | งานหลายโครงการ: บอร์ด Kanban / ปฏิทิน / ไทม์ไลน์ / ลิสต์ · งานของฉัน · คอมเมนต์ · ประวัติ · แชร์ลิงก์ |
| **Sale** (catalog) | **รายงานขาย** · **ประสิทธิภาพเซล** · **ออเดอร์** · **ภาพรวม CRM** (LINE/โทร + เป้า) · **ส่งยอด & ข้อมูล** (อัปโหลดใบเสร็จ PDF, pdf.js parser) · **สินค้า** (แคตตาล็อกลาย) |
| **บันทึกกิจกรรม** (logs) | Audit log (admin เท่านั้น) · live-tail + filter |
| **ระบบ** | Soft-delete + ถังขยะ · สิทธิ์ (admin/editor/viewer) + ล็อกหน้ารายคน · realtime + fallback · ค้นหา ⌘K · ธีมมืด/สว่าง · รายงาน LINE รายวัน (edge fn + cron) |
...
VITE_SUPABASE_PUBLISHABLE_KEY=sb_publishable_...   # แนะนำ (คีย์ใหม่จาก Supabase → API Keys)
# VITE_SUPABASE_ANON_KEY=...   # legacy JWT key — โค้ด fallback รองรับอยู่ แต่ควรย้ายไป publishable
```
